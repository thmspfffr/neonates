...
tau_GABA_E_d = 8.0 * ms                        # Decay constant of GABA-type conductances
tau_GABA_E_r = 0.25 * ms                        # Rise constant of GABA-type conductances
tau_GABA_I_d = 8.0 * ms                        # Decay constant of GABA-type conductances
...
for iAMPA, AMPA_mod in enumerate(AMPA_mods):
    for iGABA, GABA_mod in enumerate(GABA_mods):
        ...
        dict2save['gIgE'] = ((gIE_GABA * GABA_mod)+(gII_GABA * GABA_mod)) / ((gEE_AMPA * AMPA_mod) + (gEI_AMPA * AMPA_mod))
