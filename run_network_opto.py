          ...
          for iinp in range(0,inputs.size):
              for iampa in range(0,AMPA_mods.size):
                  for inmda in range(0,NMDA_mods.size):
                      ...
                      fn = os.path.expanduser(root_dir + 'proc/v%d/neonates_network_opto_iampa%d_inmda%d_gaba%d_inp%d_tr%d_v%d_processing.txt') % (v,iampa, inmda, igaba, iinp,itr,v)
                      ...
                      myclock = Clock(dt=1.0*ms,t=0.0*ms)
                      ...
                      hf = h5py.File(os.path.expanduser(root_dir + 'proc/v%d/neonates_network_opto_spiketrain_iampa%d_inmda%d_gaba%d_inp%d_tr%d_v%d.h5') % (v,iampa, inmda, igaba, iinp,itr,v), 'w')
                      ...
                      print("Saving output...")
                      hf = h5py.File(os.path.expanduser(root_dir + 'proc/v%d/neonates_network_opto_corr_iampa%d_inmda%d_gaba%d_inp%d_tr%d_v%d.h5') % (v,iampa, inmda, igaba, iinp,itr,v), 'w')
                      ...
                      hf = h5py.File(os.path.expanduser(root_dir + 'proc/v%d/neonates_network_opto_voltage_iampa%d_inmda%d_gaba%d_inp%d_tr%d_v%d.h5' % (v,iampa, inmda, igaba, iinp,itr,v) ), 'w')
